...
const Story = () => {
  return (
    <div className='overflow-hidden'>
      ...
      {/* Hero Section */}
      <div className='w-[100%] sm:h-[40vh] h-[30vh] sm:mt-0 mt-10  grid place-items-center text-center bg-[#dee9ff]'>
      ...
      {/* Body */}
      <div className='md:w-[90%] w-[95%] m-auto place-items-center  my-10'>
